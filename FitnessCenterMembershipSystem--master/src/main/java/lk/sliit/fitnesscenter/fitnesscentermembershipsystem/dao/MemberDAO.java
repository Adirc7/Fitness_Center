...
public class MemberDAO {
    ...
    private static final String FILE_PATH = "C:\\Users\\DELL\\Desktop\\oopProjText\\members.txt";
    ...
    public void addMember(Member member) {
        ...
        if (member == null || member.getMemberId() == null || member.getName() == null || member.getEmail() == null) {
            throw new IllegalArgumentException("Invalid member data"); //if this condition is true an exception is raised to indicate bad or incomplete input.
        }
